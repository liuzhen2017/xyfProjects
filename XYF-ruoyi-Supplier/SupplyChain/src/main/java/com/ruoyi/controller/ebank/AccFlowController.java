...
import com.ruoyi.service.IAccFlowService;
 ...
 */
@Controller
@RequestMapping("/system/accFlow")
public class AccFlowController extends BaseController
{
    private String prefix = "system/accFlow";
	
	@Autowired
	private IAccFlowService accFlowService;
	
	@RequiresPermissions("system:accFlow:view")
	@GetMapping()
	 ...
	 * 查询账户流水列表
	 */
	@RequiresPermissions("system:accFlow:list")
	@PostMapping("/list")
	@ResponseBody
	 ...
	 * 导出账户流水列表
	 */
	@RequiresPermissions("system:accFlow:export")
    @PostMapping("/export")
    @ResponseBody
	 ...
	 * 新增保存账户流水
	 */
	@RequiresPermissions("system:accFlow:add")
	 ...
	 * 修改保存账户流水
	 */
	@RequiresPermissions("system:accFlow:edit")
	 ...
	 * 删除账户流水
	 */
	@RequiresPermissions("system:accFlow:remove")
