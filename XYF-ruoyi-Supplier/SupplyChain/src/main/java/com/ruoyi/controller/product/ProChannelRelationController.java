...
public class ProChannelRelationController extends BaseController
{
	...
	{
		ProChannelRelation proChannelRelation = proChannelRelationService.selectProChannelRelationById(id);
	...
	{		
		return toAjax(proChannelRelationService.updateProChannelRelation(proChannelRelation));
	}
