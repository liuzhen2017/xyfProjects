...
//		//表名
//        List<String> tables = new ArrayList<>(Arrays.asList("answer_item","answer_master","subject"));
//
...
//			dsc.setUrl("jdbc:mysql://120.79.247.111:3306/QuestionBank?useUnicode=true&characterEncoding=UTF-8&useSSL=false&serverTimezone=UTC");//数据库url
