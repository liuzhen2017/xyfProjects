...
public interface JDGateWayService {
       ...
       * 获取kpl商品列表状态
       */
      List<JDGoodsState> getGoodsState(String skus);
       ...
       */
      List<JDPriceDto> getPrice(String skuIds);
       ...
       * 订单查询
       */
      List<JDOrderDto> getOrder(long orderId);

      /**
       * 订单反查
       */
      JDThirdOrderDto getOrderId(String thirdOrder);
       ...
       * @return
       */
      List<JDCheckDto> checkGoods(String skuIds);


      /**
       * 区域购买限制查询
       */
      List<JDAreaLimitDto> getAreaLimit(String sku, Long province, Long city, Long county, Long town);


      /**
       *   获取物流信息
       */
      JDLogisticsDto getOrderTrack (Long orderId);
