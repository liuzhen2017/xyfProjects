...
public interface ProductManageFeign {
       ...
       * 新增sku
       */
      @GetMapping("/sku/synsAddSku")
      ResponseInfo<String> addSku(@RequestParam("json") String json);
      ...
      ResponseInfo<Boolean> checkByPidAndCid(@RequestParam("proId") Long proId, @RequestParam("channelId") Long channelId);
       ...
       * 根据 proNo更新sku状态为下架
       */
      @GetMapping("/sku/updateSkuByProNo")
      ResponseInfo<String> updateSkuByProNo(@RequestParam("proNo") String proNo);


      /**
       * 根据分类 id查询分类名称
       */
      @GetMapping("/channel/getChannelName")
      ResponseInfo<String> getChannelNameByChannelId(@RequestParam("channelId") Long channelId);

      /**
       * 根据 proNo更新 product状态为下架
       */
      @GetMapping("/product/offSaleByproNo")
      ResponseInfo<String> offSaleByproNo(@RequestParam("proNo") String proNo);

      /**
       * 根据 proId更新 product状态为下架
       */
      @GetMapping("/product/offSaleByproId")
      ResponseInfo<String> offSaleByproId(@RequestParam("proId") Long proId);


      /**
       *  根据 skuNo查询 product
       */
      @GetMapping("/product/getProductBySkuNo")
      ResponseInfo<Product> getProductBySkuNo(@RequestParam("skuNo") String skuNo);
       ...
       * @return
       */
      @GetMapping("/sku/getProIdBySkuNo")
      ResponseInfo<Long> getProIdBySkuNo(@RequestParam("skuNo") String skuNo);
