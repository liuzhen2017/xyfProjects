 ...
 */
@Controller
@RequestMapping("/xinyunfu/custUser/")
public class CustUserController extends BaseController
{
    private String prefix = "xinyunfu/custUser";
	
	@Autowired
	private ICustUserService custUserService;
	
	@RequiresPermissions("xinyunfu:custUser:view")
	@GetMapping()
	 ...
	 * 查询用户列表
	 */
	@RequiresPermissions("xinyunfu:custUser:list")
	@PostMapping("/list")
	@ResponseBody
	 ...
	 * 导出用户列表
	 */
	@RequiresPermissions("xinyunfu:custUser:export")
    @PostMapping("/export")
    @ResponseBody
	 ...
	 * 新增保存用户
	 */
	@RequiresPermissions("xinyunfu:custUser:add")
	 ...
	 * 修改保存用户
	 */
	@RequiresPermissions("xinyunfu:custUser:edit")
	 ...
	 * 删除用户
	 */
	@RequiresPermissions("xinyunfu:custUser:remove")
