...
public interface CouponMarketMapper extends BaseMapper<CouponMarket> {
	 ...
	 * @return
	 */
	@Select("select * from coupon_market where user_no='${userNo}' and coupon_status ='06'   order by  created_date ASC  limit ${limit}")
	public List<CouponMarket> queryFirstMarketByUser(@Param("userNo") String userNo,@Param("limit") Integer limit);
	/**
	 * 根据订单号修改优惠券状态,转让价
	 * @param userNo
	 * @return
