...
public class CodeGenerator {
	...
	public static void mai1n(String[] args) {
		//表名
        List<String> tables = new ArrayList<>(Arrays.asList("error_info"));
        ...
        for (String tableName : tables) {
			...
			dsc.setUrl("jdbc:mysql://localhost:3306/QuestionBank?useUnicode=true&characterEncoding=UTF-8&useSSL=false&serverTimezone=UTC");//数据库url
