...
public class CodeGenerator {
	...
	public static void mai1n(String[] args) {
		//表名
        List<String> tables = new ArrayList<>(Arrays.asList("after_sales_order","after_sales_handle"));
        ...
        for (String tableName : tables) {
			...
			dsc.setUrl("jdbc:mysql://localhost:3306/OrderManage?useUnicode=true&characterEncoding=UTF-8&useSSL=false&serverTimezone=UTC");//数据库url
